...
var ToggleAsideNavigation = /*#__PURE__*/function () {
  function ToggleAsideNavigation() {
    ...
    this.buttonMenu.on('click', this.showAside.bind(this));
  }

  _createClass(ToggleAsideNavigation, [{
    key: "showAside",
    value: function showAside() {
      if (this.asideNavigation.css('display') !== 'flex') {
        this.asideNavigation.css('display', 'flex');
      } else {
        this.asideNavigation.hide();
      }
    }
  }]);
